            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right wow fadeInDown">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="available.php">Adopt me!!</a></li>
...
<section id="tour-packages" class="center wow fadeInDown">
    <div style="font-size:30px; font-family:verdana; font-weight:bold; color: #8B8B00; text-align:center;">Pets Ready to Adopt!!</div>

...
<section id="tour-packages" class="center wow fadeInDown">
    <div style="font-size:30px; font-family:verdana; font-weight:bold; color: #8B8B00; text-align:center;">Doctors Information</div>
        <p style="text-align:center; font-family:verdana;"><br></p>

        <div class="container" style="height:400px;">
			<iframe src="docframe.php" width="100%;" height="400px;" style="border-style:none;"></iframe>

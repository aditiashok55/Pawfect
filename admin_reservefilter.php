			   ...
			   $stat = $_POST['filter'];
			   $sql= ("Create view as view1 SELECT tblcnp.*,tblorders.* 
         ...
         $sql1=("Select * from view1")
         $result=mysqli_query($con, $sql1);
				if(mysqli_num_rows($result)>0){
					while($row = mysqli_fetch_assoc($result)){?>
               <tr class="success" style="cursor:pointer;">
               		<td style="text-align:center;"><a href="admin_reject_completed.php?id=<?php echo $row['id']?>" class="btn btn-default">

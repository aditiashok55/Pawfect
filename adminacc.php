  ...
  <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><img src="images/logos.jpg"  width="15% "/> PAWFECT!!</h4></a>
                </div>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2024 PAWFECT. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
